...
/***/ function(module, exports) {
	...
	module.exports={"v":3,"t":[{"t":7,"e":"button","a":{"class":"btn btn-primary"},"v":{"click":{"m":"toggle","a":{"r":[],"s":"[\"showModal\"]"}}},"f":["Show modal"]}," ",{"t":7,"e":"Modal","a":{"show":[{"t":2,"r":"showModal"}]},"f":[{"t":7,"e":"div","a":{"class":"modal-dialog"},"f":[{"t":7,"e":"div","a":{"class":"modal-content"},"f":[{"t":7,"e":"div","a":{"class":"modal-header"},"f":[{"t":7,"e":"button","a":{"type":"button","class":"close","aria-label":"Close"},"v":{"click":{"m":"toggle","a":{"r":[],"s":"[\"showModal\"]"}}},"f":[{"t":7,"e":"span","a":{"aria-hidden":"true"},"f":["×"]}]}," ",{"t":7,"e":"h4","a":{"class":"modal-title"},"f":["Modal title"]}]}," ",{"t":7,"e":"div","a":{"class":"modal-body"},"f":[{"t":7,"e":"p","f":["One fine body…"]}]}," ",{"t":7,"e":"div","a":{"class":"modal-footer"},"f":[{"t":7,"e":"button","a":{"type":"button","class":"btn btn-default"},"v":{"click":{"m":"toggle","a":{"r":[],"s":"[\"showModal\"]"}}},"f":["Close"]}," ",{"t":7,"e":"button","a":{"type":"button","class":"btn btn-primary"},"f":["Save changes"]}]}]}]}]}]};
